...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
    <a class="nav-link active" href="verify.php">Verify ID</a>
  </li>
</ul>
  <br>
<style type="text/css">
...
height: 450px;
      ...
      <div align="center" id="image" class="panel panel-success">
        <div class="panel-heading"><?php
        $sql = "SELECT username FROM national_id WHERE user_id = '$id'  ORDER BY date DESC LIMIT 1";
        $result = $db->query($sql);
        ...
        $result = mysql_query("SELECT DISTINCT location FROM national_id WHERE user_id  ='$id' ORDER BY date DESC LIMIT 1");
