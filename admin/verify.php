...
<div class="row container-fluid">
  ...
  <li class="nav-item">
    <a class="nav-link" href="index.php">Delete a Customer</a>
  </li>
    <li class="nav-item">
    <a class="nav-link active" href="verify.php">Verify Payment</a>
  </li>
</ul>
  ...
  <br>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM payments WHERE verified = 0";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="done.php?customer_id=<?php echo $row['user_id']; ?>"><button type="button" class="btn btn-success btn-xs">Verify</button></a></td>
                                    </tr>
                                    <?php
                                }
                            } else {
